    ...
    def _parse_arxiv_response(self, xml_content: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for entry in entries:
                ...
                paper['title'] = self._get_text(entry, 'atom:title', namespaces, '').strip()
                paper['summary'] = self._get_text(entry, 'atom:summary', namespaces, '').strip()
