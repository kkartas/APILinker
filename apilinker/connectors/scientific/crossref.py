...
class CrossRefConnector(ApiConnector):
    ...
    def __init__(self, email: str, **kwargs):
        ...
        headers = {
            "User-Agent": f"ApiLinker/0.4.0 (mailto:{email})"
        }
    ...
    def get_citation_data(
        ...
        citation_info = {
            ...
            "journal": paper_data.get("message", {}).get("container-title", ["Unknown"])[0],
            "published_date": self._extract_date(paper_data.get("message", {})),
            "citation_count": paper_data.get("message", {}).get("is-referenced-by-count", 0),
    ...
    def search_funded_research(self, funder_name: str, max_results: int = 50) -> Dict[str, Any]:
        """
    ...
    def _extract_date(self, paper_data: Dict[str, Any]) -> Optional[str]:
        ...
        date_parts = paper_data.get("published-print", paper_data.get("published-online", {}))
